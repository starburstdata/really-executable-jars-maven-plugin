...
public class ReallyExecutableJarMojo extends AbstractMojo
{
            ...
            throws IOException
    {
        ...
        try ( ZipArchiveOutputStream jar = new ZipArchiveOutputStream( file ) )
        {
            ...
            {
                zip.copyRawEntries( jar, entry -> true );
                jar.finish();
            }
        }
    ...
    private byte[] getPreamble( URI uri )
    {
        try
        {
            ...
            try ( final URLClassLoader loader = new URLClassLoader( new URL[]{ uri.toURL() }, null );
